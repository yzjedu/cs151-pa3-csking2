...
- The purpose of each algorithm is not stated above the function. 
- The input validation in lines function is not handled correctly. 
- `choice` and `cnumber` should not have been global variables. 
